        ...
        <div class="col-lg-6 col-md-8 col-sm-10">
            ...
            <form action="/trabalhoFinal/admin/vendedor/listaClientes" method="POST" accept-charset="UTF-8">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="cpf" minlength="11" maxlength="11" placeholder="Apenas números" <%= acao.equals("Excluir") ? "readonly" : "" %> value="<%= cliente != null ? cliente.getCpf() : "" %>" class="form-control">
                </div>
