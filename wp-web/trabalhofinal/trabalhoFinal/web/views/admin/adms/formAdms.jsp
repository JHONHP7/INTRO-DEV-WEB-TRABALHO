                ...
                <div class="col-sm-6 offset-3">
                    ...
                    <form action="/trabalhoFinal/admin/administrador/cadastroAdms" method="POST" accept-charset="UTF-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input  type="text" name="cpf" minlength="11" maxlength14"  placeholder="Apenas números" value="<%= funcionario != null ? funcionario.getCpf() : ""%>" class="form-control" <%= "Excluir".equals(acao) ? "readonly" : ""%>>
                        </div>
                        <div class="mb-3">
