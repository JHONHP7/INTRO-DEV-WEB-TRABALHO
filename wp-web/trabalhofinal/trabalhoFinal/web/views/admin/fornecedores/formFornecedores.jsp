<%-- 
    Document   : formFornecedores
    Created on : 25 de jun. de 2024, 20:05:49
    Author     : Pedro
--%>
                ...
                <div class="col-sm-4 offset-3">
                    ...
                    <form action="/trabalhoFinal/admin/comprador/listaFornecedores" method="POST" accept-charset="UTF-8">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="cpf" <%= acao.equals("Excluir") ? "readonly" : "" %> value="<%=fornecedor != null ? fornecedor.getCnpj() : ""%>" class="form-control">
                        </div>
