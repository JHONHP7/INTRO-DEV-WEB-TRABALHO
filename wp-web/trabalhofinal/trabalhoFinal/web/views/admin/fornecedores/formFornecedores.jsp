            ...
            <div class="col-sm-4 offset-3">
                ...
                <form action="/trabalhoFinal/admin/comprador/listaFornecedores" method="POST" accept-charset="UTF-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="cnpj" minlength="14" maxlength="14" placeholder="Apenas números"  <%= acao.equals("Excluir") ? "readonly" : "" %> value="<%=fornecedor != null ? fornecedor.getCnpj() : ""%>" class="form-control">
                    </div>
